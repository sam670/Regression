...
main_application.title('Sam text editor')
...
# cascade
main_menu.add_cascade(labe='File', menu=file)
main_menu.add_cascade(labe='Edit', menu=edit)
main_menu.add_cascade(labe='View', menu=view)
main_menu.add_cascade(labe='Color_Theme', menu=color_theme)
...
##FONT FAMILY AND FONT SIZE FUNCTIONLITY
